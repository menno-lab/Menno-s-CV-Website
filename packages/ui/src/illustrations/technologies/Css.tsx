...
export function Css({ color, textColor, alt }: IllustrationProps) {
    return (
        <svg aria-label={alt} xmlns='http://www.w3.org/2000/svg' height='100%' viewBox='0 0 512 512'>
            <path fill={color} d='M71.357 460.819L30.272 0h451.456l-41.129 460.746L255.724 512z' />
            <path fill={color} d='M405.388 431.408l35.148-393.73H256v435.146z' />
            <path
                fill={textColor}
