...
export function Aws({ color, textColor, alt }: IllustrationProps) {
    return (
        <svg aria-label={alt} height='100%' viewBox='-.1 1.1 304.9 179.8' width='100%' xmlns='http://www.w3.org/2000/svg'>
            <path
