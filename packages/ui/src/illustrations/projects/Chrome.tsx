...
export function Chrome({ color, secondaryColor, alt }: IllustrationProps) {
    return (
        <svg aria-label={alt} height='100%' version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
            <path
                fill={color}
