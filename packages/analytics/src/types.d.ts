...
const CONTACT_EVENTS = ['contact_form_submitted'] as const;

type AiEvent = (typeof AI_EVENTS)[number];
type CustomizationEvent = (typeof CUSTOMIZATION_EVENTS)[number];
type ContactEvent = (typeof CONTACT_EVENTS)[number];

export type AnalyticsEvent = AiEvent | CustomizationEvent | ContactEvent;
